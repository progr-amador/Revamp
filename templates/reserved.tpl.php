    ...
    if (empty($products)) {
        ...
        foreach ($products as $product) { 
            ...
            <div class="small-flex-item">
                <a href="product.php?id=<?php echo htmlspecialchars(strval($product['productID']), ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <div class="small-item-details">
                        ...
                        <div class="bottom-details-reserved">
                            <p id="price"><?php echo htmlspecialchars(strval($product['price']), ENT_QUOTES, 'UTF-8'); ?> €</p>
                            <form action="../code/shipping_form.php" method="get">
                                <input type="hidden" name="id" value="<?php echo htmlspecialchars(strval($product['productID']), ENT_QUOTES, 'UTF-8'); ?>">
